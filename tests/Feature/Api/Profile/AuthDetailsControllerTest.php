...
class AuthDetailsControllerTest extends ApiTestCase
{
    ...
    public function test_test_user_can_update_his_authentication_details()
    {
        $user = $this->login();
    ...
    public function test_test_user_can_update_only_email_and_leave_other_fields_unchanged()
    {
        $user = $this->login();
    ...
    public function test_test_email_field_is_required()
    {
        $this->login();
    ...
    public function test_test_email_field_must_be_valid_email()
    {
        $this->login();
    ...
    public function test_test_email_field_must_be_unique()
    {
        $this->login();
    ...
    public function test_test_username_field_must_be_unique()
    {
        $this->login();
