...
class LoginTest extends TestCase
{
    ...
    public function test_last_login_timestamp_is_updated_after_successful_login()
    {
        $testDate = Carbon::now();
    ...
    public function test_login_with_wrong_credentials_will_fail()
    {
        $this->loginUser('foo', 'bar')
    ...
    public function test_login_max_number_of_sessions_reached()
    {
        $user = UserFactory::withCredentials('foo', 'bar')->create();
    ...
    public function test_login_with_2fa_enabled()
    {
        ...
        $this->setSettings(['2fa.enabled' => true, 'throttle_enabled' => false]);
    ...
    public function test_login_with_2fa_enabled_redirect_to_custom_page()
    {
        $google2fa = new Google2FA();
        $secret = encrypt($google2fa->generateSecretKey());
    ...
    public function test_login_with_wrong_2fa_token_when_custom_redirect_page_is_provided()
    {
        $google2fa = new Google2FA();
        $secret = encrypt($google2fa->generateSecretKey());
    ...
    public function test_force_password_change_on_login()
    {
        $this->setSettings(['password-change.enabled' => true]);
