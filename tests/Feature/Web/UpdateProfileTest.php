...
class UpdateProfileTest extends TestCase
{
    ...
    public function test_test_user_can_access_his_profile_page()
    {
        $this->get('/profile')->assertOk();
    }

    public function test_test_user_can_update_his_profile_details()
    {
        Event::fake([
    ...
    public function test_test_user_cannot_change_his_status_while_updating_the_profile()
    {
        $data = $this->getStubDetailsData();
    ...
    public function test_test_user_cannot_change_his_role_while_updating_the_profile()
    {
        $data = $this->getStubDetailsData();
    ...
    public function test_test_update_avatar()
    {
        Event::fake([
            ChangedAvatar::class,
        ]);
    ...
    public function test_test_update_avatar_with_invalid_image_file()
    {
        Storage::fake('public');
    ...
    public function test_test_update_avatar_external()
    {
        Event::fake([
            ChangedAvatar::class,
        ]);
    ...
    public function test_test_update_user_login_details()
    {
        $data = [
            'email' => 'john@doe.com',
            'username' => 'milos',
    ...
    public function test_test_password_is_not_changed_if_omited_on_update()
    {
        auth()->user()->update([
    ...
    public function test_test_user_session_invalidation()
    {
