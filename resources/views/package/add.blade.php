...
@section('page-title', __('package.add_package'))
@section('page-heading', __('package.add_package'))
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pickup_date" value="{{ old('pickup_date') }}" id="pickup_date"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="quantity" value="{{ old('quantity', 1) }}" id="quantity"
                        ...
                        <div class="form-group">
                            ...
                            <select name="method" id="method" class="form-control" required>
                                ...
                                <option value="pickup" {{ old('method') == 'pickup' ? 'selected' : '' }}>
                                    @lang('package.pickup')
                                </option>
                                <option value="delivery" {{ old('method') == 'delivery' ? 'selected' : '' }}>
...
@section('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Package\CreatePackageRequest', '#package-form') !!}

    <script>
        $(document).ready(function() {
            // Initialize datepicker for pickup_date with disabled dates
