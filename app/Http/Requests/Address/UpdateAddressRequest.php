...
class UpdateAddressRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'post_code' => 'required|string|size:7|regex:/^[0-9]+$/',
    ...
    public function messages()
    {
        return [
            ...
            'post_code.size' => __('address.validation.post_code_size', ['size' => 7]),
            'post_code.regex' => __('address.validation.post_code_regex'),
            ...
            'room_no.required' => __('address.validation.room_no_required'),
        ];
    }
}
